...
def get_time_slice(full_matrix, start=0.0, period=1.0):
    """
...
def generate_feature_vectors_from_samples(
    file_path, nsamples, period, state=None, remove_redundant=True, cols_to_ignore=None
):
    """
