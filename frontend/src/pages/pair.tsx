  ...
  return (
    <div className='flex flex-col justify-center z-[1] items-center h-screen !overflow-y-scroll'>
      <div className='flex flex-col justify-center text-center items-center pt-4'>
        <h1 className="text-4xl font-bold text-black mb-6 w-full">Set Up Your Muse-S Device</h1>
      ...
      <div className="flex flex-col items-center p-6">
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-xl">
          ...
          <p className="text-lg text-gray-700 mb-6">
            With your Muse-S connected, return to Dr. DrEEG and click <span className='text-blue-600 font-semibold'>Start Karaoke</span> to begin your karaoke experience. Your brain waves will
      ...
      <div className='flex flex-col items-center p-6'>
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-xl">
          ...
          <button className="mt-6 px-6 py-2 bg-blue-500 text-white text-xl rounded hover:bg-blue-600 disabled:bg-neutral-300" disabled={isConnected ? false : true} onClick={() => router.push('/karaoke')}>
            Start Karaoke
          </button>
        </div>
      </div>
